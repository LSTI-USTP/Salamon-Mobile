...
public class DadosRegistro implements Serializable
{
	...
	public DadosRegistro(int estadoCondutor, int existenciaCarta,int incompatibilidade, String numCarta, int categoriaVeiculo,int livrete, String numMatricula) 
	{
